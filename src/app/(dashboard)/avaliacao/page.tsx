    ...
    async function init() {
      ...
      const souGestorDaCalibragemAtual =
        empresa!.id === 'ac4ad62b-9b88-44da-ae69-0f26ced07d06'
          ? ['igorecosta1@gmail.com', 'filippe.reus@ctz.eng.br', 'priscila.santos@behive.net.br', 'leticialeite2003@yahoo.com.br', 'eduardo.rigotto@behive.net.br'].includes(emailAtual)
          : administrador
      ...
      setSouVejoNineBox(
        empresa!.id === 'ac4ad62b-9b88-44da-ae69-0f26ced07d06'
          ? ['igorecosta1@gmail.com', 'priscila.santos@behive.net.br', 'leticialeite2003@yahoo.com.br', 'eduardo.rigotto@behive.net.br'].includes(emailAtual)
          : administrador
      )
